...
export const siteRoutes: RouteRecordRaw[] = [
  {
    ...
    meta: { title: "Home", publicSite: true },
  },
  {
    path: "/about",
    name: "site-about",
    component: () => import("./pages/AboutPage.vue"),
    meta: { title: "Chi siamo", publicSite: true },
  },
  {
    path: "/services",
    name: "site-services",
    component: () => import("./pages/ServicesPage.vue"),
    meta: { title: "Servizi", publicSite: true },
  },
  {
    path: "/contact",
    name: "site-contact",
    component: () => import("./pages/ContactPage.vue"),
    meta: { title: "Contatti", publicSite: true },
  },
  {
    path: "/privacy",
    name: "site-privacy",
    component: () => import("./pages/PrivacyPage.vue"),
    meta: { title: "Privacy", publicSite: true },
  },
];
